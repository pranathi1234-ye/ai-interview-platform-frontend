  ...
  const evaluateAnswer = async () => {
    ...
    try {
        ...
        try {
          ...
          evaluation = {
            ...
            feedback:
              evaluation,
            suggestion:
              "Try to give a more complete and technically accurate answer.",
          };
        }
      }
      ...
      const suggestionText =
        ...
        "Try to make your answer clearer and more complete.";
      ...
      updatedSuggestions[currentQuestion] =
        suggestionText;
